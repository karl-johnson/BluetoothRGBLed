...
#define MESSAGE_TIMEOUT_DURATION 1000 // time in ms that we wait before a message finishes;
// if we wait longer than this for a message to end, our connection prolly dropped
