...
CPP_OUTPUTPATH = os.path.join(PROJECT_ROOT,'Arduino','BluetoothRGBLed_Arduino','include','GeneratedConstants.h')

#JAVA_OUTPUTPATH = "generated/javatest.java"
JAVA_OUTPUTPATH = os.path.join(PROJECT_ROOT,'Android','BluetoothRGBLed_Android',
    'app','src','main','java','com','example',\
    'bluetoothrgbled_android','GeneratedConstants.java')
